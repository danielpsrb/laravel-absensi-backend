                    ...
                    <form action="{{ route('attendances.update', $attendance) }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="name" value="{{ $attendance->user_id }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="email" value="{{ $attendance->date }}">
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="time_out" value="{{ $attendance->time_out }}">
                                @error('study_program')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="card-footer text-right">
                            <a href="{{ route('attendances.index') }}"><button type="button" class="btn btn-danger mr-2">Cancel</button></a>
